      ...
      <div>
          ...
          >
            ...
            <div>
              <a
                class="nav-link"
                href="#"
                v-on:click="Muesra_Historial_Clientes"
                >Historial Clientes</a
              >
            </div>
          </nav>
        </div>
        <div class="content">
          ...
          <table id="myTable" v-if="muestra_cie === false">
            <colgroup>
              ...
              <col span="7" style="background-color: #78e8d7" />
            </colgroup>
            <thead>
            ...
            <tbody v-if="muestra === true">
              <!--Jesús ->|O.o|-> Estructura de la tabla para mostrar todos los registros-->
              <tr v-for="result in result" v-bind:key="result._id">
                ...
                <td>{{ result.price }}</td>
                <td>
                  <v-icon small v-on:click="Eliminar_re_Column(result._id)">
                    mdi-delete
                  </v-icon>
                </td>
              </tr>
            </tbody>
            <tbody v-if="muestra_ === true">
              <!--Jesús ->|O.o|-> Estructura de la tabla solo para mostrar el registro consultado-->
              <tr>
                <td>{{ result._id }}</td>
                <td>{{ result.name }}</td>
                <td>{{ result.picture }}</td>
            ...
            <v-navigation-drawer v-model="drawer" absolute bottom temporary>
              <v-list nav dense>
                ...
                >
                  ...
                  <v-list-item>
                    <v-list-item-title v-on:click="Observaciones_"
                      >Ficha Ciente</v-list-item-title
                    >
                  </v-list-item>
                </v-list-item-group>
              </v-list>
                    ...
                    >
                      <v-row justify="space-between">
                        <v-col cols="8">
                          <v-card-title>
                            <div>
                              <div class="text-h5">Ana Rosa Baéz</div>
        ...
        <div v-if="ocultar_crud === true">
          <v-card id="create">
            ...
            >
              ...
              <v-btn @click="Actualizar_re" fab dark small color="#15f600">
                <v-icon>mdi-pencil</v-icon>
              </v-btn>
              <v-btn v-on:click="Insertar_Ven" fab dark small color="#288BA8">
                <v-icon>mdi-plus</v-icon>
              </v-btn>
              <v-btn v-on:click="Eliminar_re" fab dark small color="#db0100">
                <v-icon>mdi-delete</v-icon>
              </v-btn>
              <v-btn v-on:click="Muestra_Direc" fab dark small color="#FFC300">
          ...
          <div style="text-align: center">
            ...
            <div class="columna">
              ...
              <p style="padding-left: 1px">
                CATEGORIA:
                <select class="confondo" name="CATEGORIA" id="CATEGORIAPRO">
            ...
            <div class="columna">
              <p>
                <button class="Boton" v-on:click="Insertar">
                  <img src="@/assets/registros.png" alt="x" />Registrar
                </button>
              </p>
              <p>
                <button class="Boton" v-on:click="CancelarIns">
                  <img src="@/assets/cancelar.png" alt="x" />Cancelar
                </button>
              </p>
              <p>
                <button class="Boton" v-on:click="LimpiarIns">
                  <img src="@/assets/limpiar-deslizar.png" alt="x" />Limpiar
                </button>
              </p>
            </div>
          </div>
        ...
        <div v-if="muesravenAct === true">
          ...
          <div style="text-align: center">
            ...
            <div class="columna">
              <p>
                <button class="Boton" v-on:click="Insertar_Act">
                  <img src="@/assets/registros.png" alt="x" />Actualizar
                </button>
              </p>
              <p>
                <button class="Boton" v-on:click="CancelarIns">
  ...
  methods: {
    ...
    Carga_Inicial: function () {
      const options = {//se crea variable "Options"
        ...
        data: { email: "roous.baez@gmail.com", password: "Baez12345" },// contiene los datos de la API "email" y "password"
      };
    ...
    Observaciones_: function () {
      //FUNCIÓN PARA VER LAS OBSERVACIONES Y LA CREDENCIAL DEL REGISTRO.
    ...
    Insertar_Ven: function () {
      //FUNCION PARA CONFIGURAR VENTANA EN MODO INSERCIÓN.
    ...
    CancelarIns: function () {
      //Jesús_Gabriel|->O.o|->> >> >>:FUNCIÓN PARA CONFIGURAR LA VENTANA AL CANCELAR REGISTRO DE ACTUALIZACIÓN O INSERCIÓN.
      this.muestravenRe = false;
      this.muesravenAct = false;
      this.imagenes_muestra = true;
      this.muestra_mapa = false;
